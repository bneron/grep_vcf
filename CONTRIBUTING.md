...
There are also many ways to contribute to the project without programming. 
...
* **Perform a [cursory search](https://github.com/bneron/grep_vcf/issues?q=is%3Aopen+is%3Aissue+label%3Abug)** to see if the problem has already been reported. 
...
* **If you're reporting that grep_vcf crashed**, 
...
* **Did the problem start happening recently** (e.g. after updating to a new version of grep_vcf) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of grep_vcf?** 
  What's the most recent version in which the problem doesn't happen? You can download older versions of grep_vcf from 
  [the releases page](https://github.com/bneron/grep_vcf/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.
* If the problem is related to working with files (e.g. opening and editing files), 

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for grep_vcf, 
...
* **Check if you're using [the latest version of grep_vcf](https://github.com/bneron/grep_vcf/releases)**.
* **Perform a [cursory search](https://github.com/bneron/grep_vcf/issues?q=is%3Aopen+is%3Aissue+label%3Aenhancement)** 
...
* **Explain why this enhancement would be useful** to most grep_vcf users.
* **Specify which version of grep_vcf you're using.** You can get the exact version by running `grep_vcf --version` in your terminal.
* **Specify the name and version of the OS you're using.**

### Your First Code Contribution

Unsure where to begin contributing to grep_vcf? You can start by looking through these `beginner` and `help-wanted` issues:
...
*grep_vcf* is written in Python3. 
